        ...
        <div class="content-wrapper">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">Ahlan Wa Sahlan, Ustadz ! <span class="text-primary">Selamat Melakukan Aktifitas dalam Sistem Informasi Masjid ini</span></h6>
                </div>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card tale-bg">
                <div class="card-people mt-auto">
                  <img src="images/dashboard/18126.jpg" alt="Masjid">
                  <div class="weather-info">
                    <div class="d-flex">
                      ...
                      <div class="ml-2">
                        <h4 class="location font-weight-normal">Bekasi, Jawa Barat</h4>
              ...
              <div class="row">
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body">
                      <p class="mb-4">Pemasukkan Kas Masjid</p>
                      <p class="fs-30 mb-2">Rp 2.000.000,-</p>
                      <p>Pemasukkan Kas Mingguan</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-dark-blue">
                    <div class="card-body">
                      <p class="mb-4">Pemasukkan Kas Jum'at</p>
                      <p class="fs-30 mb-2">Rp 1.000.000,-</p>
                      <p>Pemasukkan Kas Jum'at Terakhir</p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                  <div class="card card-light-blue">
                    <div class="card-body">
                      <p class="mb-4">Pengeluaran Kas Masjid</p>
                      <p class="fs-30 mb-2">Rp 1.000.000,-</p>
                      <p>Total Pengeluaran Kas Masjid</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 stretch-card transparent">
                  <div class="card card-light-danger">
                    <div class="card-body">
                      <p class="mb-4">Keseluruhan Kas Masjid</p>
                      <p class="fs-30 mb-2">Rp 30.000.000,-</p>
          ...
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Grafik Pemasukan Kas Masjid</p>
              ...
              <div class="card">
                <div class="card-body">
                 <div class="d-flex justify-content-between">
                  <p class="card-title">Report Pemasukkan Kas Masjid</p>
